...
From the `cpython-review-findings` catalog (29 recorded). These are context, not fresh discoveries: confirm each still reproduces in one line, then spend your effort on **un-found siblings** of the same shape (via its guarded twin).
